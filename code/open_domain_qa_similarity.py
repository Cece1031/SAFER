...
parser.add_argument('--similarity-model',
                    default=r'<PATH_TO_MODEL_CACHE>\stsb-distilroberta-base',
...
for generation in tqdm.tqdm(generations):
    ...
    #         elif j > i:
    #             similarity_dict[id][i].append(similarity_model.predict([qa_1, qa_2]))  # [label, prediction]
    #         elif j < i:
    ...
    for sampled_gen in sampled_generated_texts:
        ...
        similarity_to_gt_list.append(similarity_model.predict([qa_1, qa_2]))  # [label, prediction]
